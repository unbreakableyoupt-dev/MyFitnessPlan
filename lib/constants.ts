...
export const EQUIPMENT_OPTIONS = [
  {
    id: 'full_gym',
    label: 'Full Gym',
    description: 'Machines, cables, full free-weight setup',
    icon: '🏢',
  },
  {
    id: 'home_gym',
    label: 'Home Gym',
    description: 'Squat rack, barbell, dumbbells, some machines',
    icon: '🏠',
  },
  {
    id: 'barbell_rack',
    label: 'Barbell + Rack Only',
    description: 'Barbell, plates, squat rack — nothing else',
    icon: '🏋️',
  },
  {
    id: 'dumbbells_only',
    label: 'Dumbbells Only',
    description: 'Dumbbell set, maybe a bench',
    icon: '🔵',
  },
  {
    id: 'bodyweight_only',
    label: 'Bodyweight Only',
    description: 'No equipment — pull-up bar optional',
    icon: '🤸',
  },
]
